...
@Component({
  selector: 'app-espace-teacher',
  templateUrl: './espace-teacher.component.html',
  styleUrls: ['./espace-teacher.component.css']
})
export class EspaceTeacherComponent implements OnInit {
  searchText:any;
  filteredData:any;
  filteredData2:any;
