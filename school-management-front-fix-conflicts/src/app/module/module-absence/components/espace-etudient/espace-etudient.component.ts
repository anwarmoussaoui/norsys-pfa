...
import {Absence} from "../list-absence/absence";

@Component({
  selector: 'app-espace-etudient',
  templateUrl: './espace-etudient.component.html',
  styleUrls: ['./espace-etudient.component.css']
})
export class EspaceEtudientComponent implements OnInit {
  searchText:any;
  filteredData:any;
  filteredData2:any;
